...
public class BlocksRegistry {
    ...
    public static final Block APPRAISAL_TABLE_BLOCK = Registry.register(Registry.BLOCK, APPRAISAL_TABLE, new Block(FabricBlockSettings.of(Material.WOOD).strength(0.6f)));
    ...
    public static final Block COIN_BAG_BLOCK = Registry.register(Registry.BLOCK, COIN_BAG,
            new CoinBagBlock(FabricBlockSettings.of(Material.WOOL).strength(0.6f)));
    public static final BlockEntityType<CoinBagBlockEntity> COIN_BAG_BLOCK_ENTITY;
    ...
    static {
        ...
        COIN_BAG_BLOCK_ENTITY = Registry.register(Registry.BLOCK_ENTITY_TYPE, COIN_BAG, FabricBlockEntityTypeBuilder.create(CoinBagBlockEntity::new, COIN_BAG_BLOCK).build(null));
    }
